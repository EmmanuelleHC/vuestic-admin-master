<template>
  <div class="master-role">
    <va-card>
      <va-button type="button" color="success" @click="addRole()"
      >Add
      </va-button>

      <div class="row">
        <data-table-role :listRole="listRole" class="mb-4" />
      </div>
    </va-card>
    <div>
      <va-modal
      ...
      >
        <form>
          <div>
            <va-input v-model="role_name" placeholder="Role Name"> </va-input>
